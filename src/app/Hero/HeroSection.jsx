        ...
        <div className="text-center relative">
          ...
          <div className="relative overflow-hidden">
            <motion.h1
              ...
              className="will-change-transform text-[80px] sm:text-[120px] md:text-[180px] lg:text-[230px] xl:text-[280px] font-bold text-[#e8f7fc] leading-[0.85] tracking-tighter drop-shadow-[0_0_30px_rgba(232,247,252,0.15)]"
            >
              Muzahid

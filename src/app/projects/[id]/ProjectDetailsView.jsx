                        ...
                        <div className="grid grid-cols-1 gap-12 mt-8">
                            {project.images.slice(1).map((img, index) => (
                                <MaskedReveal key={index} delay={0.2 + (index * 0.1)} className="w-full">
                                    <div className="relative w-full h-auto rounded-2xl overflow-hidden bg-zinc-900 border border-white/5 group">
                                        <Image
                                            src={img}
                                            alt={`${project.title} detail ${index + 1}`}
                                            width={1200}
                                            height={800}
                                            className="w-full h-auto object-cover group-hover:scale-99 transition-transform duration-700"
                                        />
